  ...
  return (
    <Box maxWidth="650px" mx="auto">
      ...
      <SectionBody>
        ...
        Hyperweb does not recommend that any cryptocurrency should be bought,
      ...
      <SectionBody>
        Hyperweb will strive to ensure accuracy of information listed on this
        website although it will not hold any responsibility for any missing or
        wrong information. Hyperweb provides all information as is. You
      ...
      <SectionBody>
        The users of Hyperweb app are solely responsible to determinate what,
        if any, taxes apply to their cryptocurrency transactions. The owners of,
        or contributors to, the Hyperweb app are NOT responsible for
        determining the taxes that apply to cryptocurrency transactions.
      </SectionBody>
      <SectionTitle>Software Disclaimer</SectionTitle>
      <SectionBody>
        Hyperweb leverages decentralized peer-to-peer blockchains that people
        ...
        use of Hyperweb involves various risks, including, but not limited, to
        ...
        ) developed much of the initial code for the Hyperweb app, it does not
        ...
        governance tokens. No developer or entity involved in creating Hyperweb
        ...
        Hyperweb app, including any direct, indirect, incidental, special,
