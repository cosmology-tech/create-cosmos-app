...
- **This example showcases**:
  - Querying account balances on the Injective network using react-query hooks in `src/codegen` directory generated by [Telescope](https://github.com/cosmology-tech/telescope)
...
- Alternatively, if you don't want to generate `src/codegen` manually, you can use package [injective-react](https://github.com/cosmology-tech/interchainjs/blob/main/libs/injective-react/README.md#usage)
