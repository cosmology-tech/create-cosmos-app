...
- **This example showcases**:
  - Querying account balances on the Injective network using React Query hooks from the `src/codegen` directory, generated by [Telescope](https://github.com/cosmology-tech/telescope)
...
- Alternatively, to avoid manually generating the `src/codegen` directory, you can use [injective-react](https://github.com/cosmology-tech/interchainjs/blob/main/libs/injective-react/README.md#usage) package.
