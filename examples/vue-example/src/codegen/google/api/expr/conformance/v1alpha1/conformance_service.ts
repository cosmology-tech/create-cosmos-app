...
GlobalDecoderRegistry.register(ParseRequest.typeUrl, ParseRequest);
...
GlobalDecoderRegistry.register(ParseResponse.typeUrl, ParseResponse);
...
GlobalDecoderRegistry.register(IssueDetails.typeUrl, IssueDetails);