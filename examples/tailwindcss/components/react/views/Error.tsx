  ...
  return (
    <div className="mt-3 text-center sm:mt-1.5">
      ...
      <div className="flex flex-col w-full h-full py-6 mt-4 sm:px-8">
        ...
        <p className="mt-6 font-medium text-black">An error has occured</p>
        <p className="mt-2 text-sm text-gray-500">Lorem ipsum dolor sit amet</p>
        <button
          className="rounded-lg bg-purple-damp hover:bg-purple-damp/75 inline-flex justify-center items-center py-2.5 font-medium mt-6 text-white"
          onClick={onReconnect}
        >
