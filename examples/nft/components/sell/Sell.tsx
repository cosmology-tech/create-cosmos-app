...
export function Sell() {
  ...
  const { image, traits, creator, lastSale, mintPrice, onShare, onDownload } =
  ...
  return (
    ...
    >
      ...
      >
        ...
        <BasicModal
          isOpen={burnModal.open}
          title={burnModal.title}
          onClose={toggleBurnModal}
        >
          <Burn onBurn={onBurn} onCancal={toggleBurnModal} />
        </BasicModal>

        <BasicModal
          isOpen={unlistModal.open}
          title={unlistModal.title}
          onClose={toggleUnlistModal}
        >
          <Unlist
            isLoading={isUnlisting}
            onUnlist={onUnlist}
            onCancal={toggleUnlistModal}
          />
        </BasicModal>
