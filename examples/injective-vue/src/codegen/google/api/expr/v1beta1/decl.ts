...
GlobalDecoderRegistry.register(DeclType.typeUrl, DeclType);
...
GlobalDecoderRegistry.register(IdentDecl.typeUrl, IdentDecl);
...
GlobalDecoderRegistry.register(FunctionDecl.typeUrl, FunctionDecl);