...
GlobalDecoderRegistry.register(Quota.typeUrl, Quota);
...
GlobalDecoderRegistry.register(MetricRule.typeUrl, MetricRule);
...
GlobalDecoderRegistry.register(QuotaLimit.typeUrl, QuotaLimit);